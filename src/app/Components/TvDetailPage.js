...
export default async function TvDetailPage(props) {
  ...
  const getNextEpisode = () => {
    if (res.next_episode_to_air) {
      ...
      return (
        <p>
          <span className="type">{"Episode " + res.last_episode_to_air.episode_type}</span>
          <span><i className="bi bi-calendar3"></i> <Link href="#"> {res.next_episode_to_air.name}</Link> ({res.next_episode_to_air.season_number +"x" +res.next_episode_to_air.episode_number}), {anotherDateFormat}</span>
        </p>
      );
    } else{
            ...
            <div className="series-data">
              ...
              <div className="data">
                ...
                <div className="card">
                  ...
                  <p><span className="type">{"Episode "+res.last_episode_to_air.episode_type}</span></p>
                  {/* <p>
                    <span className="type">{"Episode " + res.last_episode_to_air.episode_type}</span> <span><i className="bi bi-calendar3"></i> <Link href="#"> {res.next_episode_to_air.name}</Link> ({res.next_episode_to_air.season_number + "x" +res.next_episode_to_air.episode_number}), {anotherDateFormat}</span>
                  </p> */}
                </div>
              </div>
            </div>
