...
const getTvData = async (props) => {
  let data = await fetch("http://localhost:3000/api/tv_top-rated_" + props);
      ...
      <div className="content">
        <div className="card-expand">
          ...
          <div className="card-data">
            ...
            <TvGenres page={"tv_top-rated_" + page} />
            ...
            <div className="opposites_react">
              ...
              <div className="overview">
                ...
                <GetTvCreator page={"tv_top-rated_" + page} />
                <SpokenLang page={"tv_top-rated_" + page} />
                <p>
          ...
          <div className="section">
            ...
            <div className="series-data w-100">
              ...
              <GetTvSeasons page={"tv_top-rated_" + page} />
            </div>
          </div>
          <div className="other-composite">
            <div className="production">
              <ProductionCom page={"tv_top-rated_"+page} />
              <ProductionCountry page={"tv_top-rated_"+page} />
            </div>
            <div className="sidebar">
              ...
              <TvNetworksList page={"tv_top-rated_" + page} />
              <p>
