...
const getTvData = async (props) => {
  let data = await fetch("http://localhost:3000/api/tv_airing-today_" + props);
      ...
      <div className="content">
        <div className="card-expand">
          ...
          <div className="card-data">
            ...
            <TvGenres page={"tv_airing-today_" + page} />
            ...
            <div className="opposites_react">
              ...
              <div className="overview">
                ...
                <GetTvCreator page={"tv_airing-today_" + page} />
                <SpokenLang page={"tv_airing-today_" + page} />
                <p>
          ...
          <div className="section">
            ...
            <div className="series-data w-100">
              ...
              <GetTvSeasons page={"tv_airing-today_" + page} />
            </div>
          </div>
          <div className="other-composite">
            <div className="production">
              <ProductionCom page={"tv_airing-today_"+page} />
              <ProductionCountry page={"tv_airing-today_"+page} />
            </div>
            <div className="sidebar">
              ...
              <TvNetworksList page={"tv_airing-today_" + page} />
              <p>
