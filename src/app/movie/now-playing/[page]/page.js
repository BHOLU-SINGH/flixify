...
const getMovieData = async (props) => {
  let data = await fetch("http://localhost:3000/api/movie_now-playing_" + props);
      ...
      <div className="content">
        <div className="card-expand">
          ...
          <div className="card-data">
            ...
            <MovieGenres page={"movie_now-playing_"+page} />
          ...
          <div className="other-composite">
            <div className="production">
              <ProductionCom page={"movie_now-playing_"+page} />
              <ProductionCountry page={"movie_now-playing_"+page} /> 
            </div>
