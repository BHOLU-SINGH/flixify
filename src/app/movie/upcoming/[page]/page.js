...
const getMovieData = async (props) => {
  let data = await fetch("http://localhost:3000/api/movie_upcoming_" + props);
      ...
      <div className="content">
        <div className="card-expand">
          ...
          <div className="card-data">
            ...
            <MovieGenres page={"movie_upcoming_"+page} />
            ...
            <div className="opposites_react">
              ...
              <div className="overview">
                ...
                <SpokenLang page={"movie_upcoming_"+page} />
                <p>
          ...
          <div className="other-composite">
            <div className="production">
              <ProductionCom page={"movie_upcoming_"+page} />
              <ProductionCountry page={"movie_upcoming_"+page} /> 
            </div>
